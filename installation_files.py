...
DRIVE_ROOT_DIR = "/content/gdrive/MyDrive/object_detection/"
...
def connect_google_drive(project_name):
    ...
    if not os.path.exists(model_dir):
        ...
        print("You'll find the project on Google Drive, on the folder object_detection/{} .".format(project_name))
    else:
...
def find_existing_weights(project_name):
    dnn_path = "/content/gdrive/MyDrive/object_detection/{}/dnn".format(project_name)
